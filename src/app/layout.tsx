...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "EffiXpert - Clean NextJs Template for Home Remodelling",
    description: "Home Remodeling Framer Template that creates a high-converting remodeling website with EffiXpert - Home Remodelling Website Template. Purchase now!",
    images: [
      {
...
/* 
    Template Name: EffiXpert - Clean NextJs Template for Home Remodelling
    ...
    Text Domain: EffiXpert | Next.js | Portfolio Template
*/