                        ...
                        <div className="col-span-12 md:col-span-7 xl:col-span-8">
                            <div className="space-y-5 text-center md:text-left">
                                ...
                                <p
                                    ...
                                    data-aos-delay="600"
                                >
                                    From kitchens to full-home upgrades, EffiXpert helps bring your vision to life with seamless project execution and expert craftsmanship. Ready to begin your transformation?
                                </p>

                                {/* Button */}
                                <div data-aos="fade-up" data-aos-delay="800">
                                    <Link href="#" className="group d2c_btn inline-block">
