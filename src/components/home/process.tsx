                ...
                <div className="grid md:grid-cols-2 gap-8">
                    ...
                    <div className="order-1 relative" data-aos="fade-in">
                        <Image
                            ...
                            className="d2c_process_image"
                        />
                        <div className="d2c_process_image_overlay"></div>
                    </div>
                    <div className="lg:p-6 xl:p-20 !pr-0 flex items-center order-2">
                        <div className="space-y-3" data-aos="fade-left" data-aos-delay="400">
                            <h4 className="text-[#C2D6C9]/30 text-5xl-1">001</h4>
                    ...
                    <div className="lg:p-6 xl:p-20 !pr-0 !pl-0 flex items-center order-4 md:order-3">
                        <div className="space-y-3" data-aos="fade-right" data-aos-delay="400">
                            <h4 className="text-[#C2D6C9]/30 text-5xl-1">002</h4>
                            <p className="text-base font-medium text-secondary">
                                Understanding your lifestyle and design goals.
                            </p>
                            ...
                            <p>
                                ...
                                design and plan. You&apos;ll know exactly what to expect before we
                                begin building.
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="lg:p-6 xl:p-20 !pr-0 flex items-center order-6">
                        <div className="space-y-3" data-aos="fade-left" data-aos-delay="400">
                            <h4 className="text-[#C2D6C9]/30 text-5xl-1">003</h4>
                            <p className="text-base font-medium text-secondary">
                    ...
                    <div className="lg:p-6 xl:p-20 !pr-0 !pl-0 flex items-center order-8 md:order-7">
                        <div className="space-y-3" data-aos="fade-right" data-aos-delay="400">
                            <h4 className="text-[#C2D6C9]/30 text-5xl-1">004</h4>
                            <p className="text-base font-medium text-secondary">
                            ...
                            <p>
                                ...
                                your satisfaction. Once approved, your new space is ready for you
                                to enjoy with full confidence.
                            </p>
                        </div>
                    </div>
