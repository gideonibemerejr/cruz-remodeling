			...
			<div className="container">
				<div className="grid grid-cols-12 gap-8">
					...
					<div className="col-span-12 lg:col-span-4">
						<h2 className="title xl:text-[76px] text-white py-6 text-center md:text-left animateText !normal-case">
							Cruz Remodeling
						</h2>
						...
						<div className="flex space-x-4">
							<a
								href="#"
								className="text-[#C2D6C9] hover:text-primary transition-colors"
							>
								<svg
									className="w-6 h-6"
									fill="currentColor"
				...
				{/* Copyright */}
				<div className="grid grid-cols-12 p-2 xl:py-4 copyright">
